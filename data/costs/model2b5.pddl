(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-5) (:DOMAIN CELL-ASSEMBLY)
 (:OBJECTS ARM - ARM B-0 B-1 B-2 B-3 B-4 - BASE PART-A PART-B PART-C -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM SCREW-MACHINE-C)
  ...
  (AT B-4 CARRY-IN) (FINISHED NOTHING-DONE B-4) (FREE ARM) (AT ARM TABLE-IN)

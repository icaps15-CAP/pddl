(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-5) (:DOMAIN CELL-ASSEMBLY)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 B-2 B-3 B-4 - BASE PART-A PART-B PART-C -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (FINISHED NOTHING-DONE B-4) (FREE ARM1) (AT ARM1 TRAY-A) (ARM-PRESENT TRAY-A)

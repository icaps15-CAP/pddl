(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3A-2) (:DOMAIN CELL-ASSEMBLY)
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 TABLE-IN)
  ...
  (AT B-1 CARRY-IN) (FINISHED NOTHING-DONE B-1) (FREE ARM1) (AT ARM1 T1)
  (ARM-PRESENT T1) (FREE ARM2) (AT ARM2 M4) (ARM-PRESENT M4) (FREE ARM3)
  (AT ARM3 TB23) (ARM-PRESENT TB23))
 (:GOAL

(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-2)
 ...
 (:OBJECTS ARM1 ARM2 - ARM
           BASE-2A-0 BASE-2A-1 BASE-2B-0 BASE-2B-1 - BASE
           PART-2A-A-0 PART-2A-A-1 PART-2A-B-0 PART-2A-B-1 PART-2A-C-0 PART-2A-C-1 PART-2B-A-0 PART-2B-A-1 PART-2B-B-0 PART-2B-B-1 PART-2B-C-0 PART-2B-C-1 - COMPONENT

(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-6)
 ...
 (:OBJECTS ARM1 ARM2 - ARM
           BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4 BASE-2A-5 BASE-2B-0 BASE-2B-1 BASE-2B-2 BASE-2B-3 BASE-2B-4 BASE-2B-5 - BASE
           PART-2A-A-0 PART-2A-A-1 PART-2A-A-2 PART-2A-A-3 PART-2A-A-4 PART-2A-A-5 PART-2A-B-0 PART-2A-B-1 PART-2A-B-2 PART-2A-B-3 PART-2A-B-4 PART-2A-B-5 PART-2A-C-0 PART-2A-C-1 PART-2A-C-2 PART-2A-C-3 PART-2A-C-4 PART-2A-C-5 PART-2B-A-0 PART-2B-A-1 PART-2B-A-2 PART-2B-A-3 PART-2B-A-4 PART-2B-A-5 PART-2B-B-0 PART-2B-B-1 PART-2B-B-2 PART-2B-B-3 PART-2B-B-4 PART-2B-B-5 PART-2B-C-0 PART-2B-C-1 PART-2B-C-2 PART-2B-C-3 PART-2B-C-4 PART-2B-C-5 - COMPONENT

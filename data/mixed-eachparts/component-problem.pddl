(DEFINE
 (PROBLEM
  CELL-ASSEMBLY-2A2B-MIXED-EACH-5-PART-2A-B-4-PART-2A-A-4-PART-2A-C-4-BASE-2A-4)

 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS PART-2A-B-4 - COMPONENT
           PART-2A-A-4 - COMPONENT
           PART-2A-C-4 - COMPONENT
           BASE-2A-4 - BASE
 ...
 (:INIT
  ...
  (= (JOB-COST 2A-INSPECT-BASE) 2)
  (DEPENDS 2A-SCREW-C 2A-INSPECT-BASE)
  (JOB-AVAILABLE-AT 2A-INSPECT-BASE INSPECTION-MACHINE)
  (= (JOB-COST 2A-SCREW-C) 3)
  (DEPENDS 2A-ATTATCH-C 2A-SCREW-C)
  (JOB-AVAILABLE-AT 2A-SCREW-C SCREW-MACHINE-C)
  (AT PART-2A-C-4 TRAY-C)
  (USES 2A-ATTATCH-C PART-2A-C-4)
  (= (JOB-COST 2A-ATTATCH-C) 2)
  (DEPENDS 2A-ATTATCH-B 2A-ATTATCH-C)
  (JOB-AVAILABLE-AT 2A-ATTATCH-C TABLE2)
  (AT PART-2A-B-4 TRAY-B)
  (USES 2A-ATTATCH-B PART-2A-B-4)
  (= (JOB-COST 2A-ATTATCH-B) 2)
  (DEPENDS 2A-OIL-CYLINDER 2A-ATTATCH-B)
  (JOB-AVAILABLE-AT 2A-ATTATCH-B TABLE2)
  (= (JOB-COST 2A-OIL-CYLINDER) 2)
  (DEPENDS 2A-SCREW-A 2A-OIL-CYLINDER)
  (JOB-AVAILABLE-AT 2A-OIL-CYLINDER OILING-MACHINE)
  (= (JOB-COST 2A-SCREW-A) 2)
  (DEPENDS 2A-ATTATCH-A 2A-SCREW-A)
  (JOB-AVAILABLE-AT 2A-SCREW-A SCREW-MACHINE-A)
  (AT PART-2A-A-4 TRAY-A)
  (USES 2A-ATTATCH-A PART-2A-A-4)
  (= (JOB-COST 2A-ATTATCH-A) 3)
  (DEPENDS 2A-INSERT-GASKET 2A-ATTATCH-A)
  (JOB-AVAILABLE-AT 2A-ATTATCH-A TABLE1)
  (= (JOB-COST 2A-INSERT-GASKET) 3)
  (DEPENDS NOTHING-DONE 2A-INSERT-GASKET)
  (JOB-AVAILABLE-AT 2A-INSERT-GASKET GASKET-MACHINE)
  (= (JOB-COST NOTHING-DONE) 0)
  (= (JOB-COST 2B-SCREW-C) 2)
  (DEPENDS 2B-ATTATCH-C 2B-SCREW-C)
  (JOB-AVAILABLE-AT 2B-SCREW-C SCREW-MACHINE-C)
  (= (JOB-COST 2B-ATTATCH-C) 2)
  (DEPENDS 2B-ATTATCH-B 2B-ATTATCH-C)
  (JOB-AVAILABLE-AT 2B-ATTATCH-C TABLE1)
  (= (JOB-COST 2B-ATTATCH-B) 3)
  (DEPENDS 2B-SCREW-A 2B-ATTATCH-B)
  (JOB-AVAILABLE-AT 2B-ATTATCH-B TABLE1)
  (= (JOB-COST 2B-SCREW-A) 2)
  (DEPENDS 2B-ATTATCH-A 2B-SCREW-A)
  (JOB-AVAILABLE-AT 2B-SCREW-A SCREW-MACHINE-A)
  (= (JOB-COST 2B-ATTATCH-A) 2)
  (DEPENDS NOTHING-DONE 2B-ATTATCH-A)
  (JOB-AVAILABLE-AT 2B-ATTATCH-A TABLE-IN)
  (= (JOB-COST NOTHING-DONE) 0)
 ...
 (:GOAL
  (AND (FINISHED 2A-INSPECT-BASE BASE-2A-4)
       (AT BASE-2A-4 CARRY-OUT)))

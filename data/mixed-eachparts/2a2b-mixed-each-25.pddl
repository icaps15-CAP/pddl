(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-25)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  BASE-2A-19 BASE-2A-20 BASE-2A-21 BASE-2A-22 BASE-2A-23 BASE-2A-24 BASE-2B-0
  ...
  BASE-2B-22 BASE-2B-23 BASE-2B-24 - BASE PART-2A-A-0 PART-2A-A-1 PART-2A-A-2
  ...
  PART-2A-A-21 PART-2A-A-22 PART-2A-A-23 PART-2A-A-24 PART-2A-B-0 PART-2A-B-1
  ...
  PART-2A-B-20 PART-2A-B-21 PART-2A-B-22 PART-2A-B-23 PART-2A-B-24 PART-2A-C-0
  ...
  PART-2B-A-24 PART-2B-B-0 PART-2B-B-1 PART-2B-B-2 PART-2B-B-3 PART-2B-B-4
  ...
  PART-2B-B-23 PART-2B-B-24 PART-2B-C-0 PART-2B-C-1 PART-2B-C-2 PART-2B-C-3
  ...
  PART-2B-C-22 PART-2B-C-23 PART-2B-C-24 - COMPONENT TRAY-A TRAY-B TRAY-C -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-24 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-24 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-24 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-24 TRAY-A)
  ...
  (COMPONENT-BASE PART-2B-C-24 BASE-2B-24) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-24) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-24) (FREE ARM1) (AT ARM1 TRAY-A)

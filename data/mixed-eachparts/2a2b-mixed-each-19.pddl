(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-19)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  BASE-2B-14 BASE-2B-15 BASE-2B-16 BASE-2B-17 BASE-2B-18 - BASE PART-2A-A-0
  ...
  PART-2A-B-18 PART-2A-C-0 PART-2A-C-1 PART-2A-C-2 PART-2A-C-3 PART-2A-C-4
  ...
  PART-2A-C-17 PART-2A-C-18 PART-2B-A-0 PART-2B-A-1 PART-2B-A-2 PART-2B-A-3
  ...
  PART-2B-A-16 PART-2B-A-17 PART-2B-A-18 PART-2B-B-0 PART-2B-B-1 PART-2B-B-2
  ...
  PART-2B-B-15 PART-2B-B-16 PART-2B-B-17 PART-2B-B-18 PART-2B-C-0 PART-2B-C-1
  ...
  PART-2B-C-14 PART-2B-C-15 PART-2B-C-16 PART-2B-C-17 PART-2B-C-18 - COMPONENT
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-18 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-18 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-18 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-18 TRAY-A)
  ...
  (COMPONENT-BASE PART-2B-C-18 BASE-2B-18) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-18) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-18) (FREE ARM1) (AT ARM1 TRAY-A)

(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-5)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  2A-INSERT-GASKET - MACHINE-JOB 2A-ATTATCH-A - JOB 2A-SCREW-A - MACHINE-JOB
  2A-OIL-CYLINDER - MACHINE-JOB 2A-ATTATCH-B - JOB 2A-ATTATCH-C - JOB
  2A-SCREW-C - MACHINE-JOB 2A-INSPECT-BASE - MACHINE-JOB 2B-ATTATCH-A - JOB
  2B-SCREW-A - MACHINE-JOB 2B-ATTATCH-B - JOB 2B-ATTATCH-C - JOB 2B-SCREW-C -
  MACHINE-JOB)
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-4 TRAY-C)
  (USES 2A-ATTATCH-C PART-2A-C-4) (AT PART-2A-C-3 TRAY-C)
  (USES 2A-ATTATCH-C PART-2A-C-3) (AT PART-2A-C-2 TRAY-C)
  (USES 2A-ATTATCH-C PART-2A-C-2) (AT PART-2A-C-1 TRAY-C)
  (USES 2A-ATTATCH-C PART-2A-C-1) (AT PART-2A-C-0 TRAY-C)
  (USES 2A-ATTATCH-C PART-2A-C-0) (= (JOB-COST 2A-ATTATCH-C) 2)
  (DEPENDS 2A-ATTATCH-B 2A-ATTATCH-C) (JOB-AVAILABLE-AT 2A-ATTATCH-C TABLE2)
  (AT PART-2A-B-4 TRAY-B) (USES 2A-ATTATCH-B PART-2A-B-4)
  (AT PART-2A-B-3 TRAY-B) (USES 2A-ATTATCH-B PART-2A-B-3)
  (AT PART-2A-B-2 TRAY-B) (USES 2A-ATTATCH-B PART-2A-B-2)
  (AT PART-2A-B-1 TRAY-B) (USES 2A-ATTATCH-B PART-2A-B-1)
  (AT PART-2A-B-0 TRAY-B) (USES 2A-ATTATCH-B PART-2A-B-0)
  (= (JOB-COST 2A-ATTATCH-B) 2) (DEPENDS 2A-OIL-CYLINDER 2A-ATTATCH-B)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-4 TRAY-A)
  (USES 2A-ATTATCH-A PART-2A-A-4) (AT PART-2A-A-3 TRAY-A)
  (USES 2A-ATTATCH-A PART-2A-A-3) (AT PART-2A-A-2 TRAY-A)
  (USES 2A-ATTATCH-A PART-2A-A-2) (AT PART-2A-A-1 TRAY-A)
  (USES 2A-ATTATCH-A PART-2A-A-1) (AT PART-2A-A-0 TRAY-A)
  (USES 2A-ATTATCH-A PART-2A-A-0) (= (JOB-COST 2A-ATTATCH-A) 3)
  (DEPENDS 2A-INSERT-GASKET 2A-ATTATCH-A)
  (JOB-AVAILABLE-AT 2A-ATTATCH-A TABLE1) (= (JOB-COST 2A-INSERT-GASKET) 3)
  (DEPENDS NOTHING-DONE 2A-INSERT-GASKET)
  (JOB-AVAILABLE-AT 2A-INSERT-GASKET GASKET-MACHINE)
  (= (JOB-COST NOTHING-DONE) 0) (= (JOB-COST 2B-SCREW-C) 2)
  (DEPENDS 2B-ATTATCH-C 2B-SCREW-C)
  (JOB-AVAILABLE-AT 2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-4 TRAY-C)
  (USES 2B-ATTATCH-C PART-2B-C-4) (AT PART-2B-C-3 TRAY-C)
  (USES 2B-ATTATCH-C PART-2B-C-3) (AT PART-2B-C-2 TRAY-C)
  (USES 2B-ATTATCH-C PART-2B-C-2) (AT PART-2B-C-1 TRAY-C)
  (USES 2B-ATTATCH-C PART-2B-C-1) (AT PART-2B-C-0 TRAY-C)
  ...
  (AT PART-2B-B-4 TRAY-B) (USES 2B-ATTATCH-B PART-2B-B-4)
  (AT PART-2B-B-3 TRAY-B) (USES 2B-ATTATCH-B PART-2B-B-3)
  (AT PART-2B-B-2 TRAY-B) (USES 2B-ATTATCH-B PART-2B-B-2)
  (AT PART-2B-B-1 TRAY-B) (USES 2B-ATTATCH-B PART-2B-B-1)
  (AT PART-2B-B-0 TRAY-B) (USES 2B-ATTATCH-B PART-2B-B-0)
  (= (JOB-COST 2B-ATTATCH-B) 3) (DEPENDS 2B-SCREW-A 2B-ATTATCH-B)
  (JOB-AVAILABLE-AT 2B-ATTATCH-B TABLE1) (= (JOB-COST 2B-SCREW-A) 2)
  (DEPENDS 2B-ATTATCH-A 2B-SCREW-A)
  (JOB-AVAILABLE-AT 2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-4 TRAY-A)
  (USES 2B-ATTATCH-A PART-2B-A-4) (AT PART-2B-A-3 TRAY-A)
  (USES 2B-ATTATCH-A PART-2B-A-3) (AT PART-2B-A-2 TRAY-A)
  (USES 2B-ATTATCH-A PART-2B-A-2) (AT PART-2B-A-1 TRAY-A)
  (USES 2B-ATTATCH-A PART-2B-A-1) (AT PART-2B-A-0 TRAY-A)
  (USES 2B-ATTATCH-A PART-2B-A-0) (= (JOB-COST 2B-ATTATCH-A) 2)
  ...
  (COMPONENT-BASE PART-2A-A-1 BASE-2A-1) (COMPONENT-BASE PART-2A-A-2 BASE-2A-2)
  (COMPONENT-BASE PART-2A-A-3 BASE-2A-3) (COMPONENT-BASE PART-2A-A-4 BASE-2A-4)
  ...
  (COMPONENT-BASE PART-2A-B-4 BASE-2A-4) (COMPONENT-BASE PART-2A-C-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-C-1 BASE-2A-1) (COMPONENT-BASE PART-2A-C-2 BASE-2A-2)
  (COMPONENT-BASE PART-2A-C-3 BASE-2A-3) (COMPONENT-BASE PART-2A-C-4 BASE-2A-4)
  ...
  (COMPONENT-BASE PART-2B-A-4 BASE-2B-4) (COMPONENT-BASE PART-2B-B-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-B-1 BASE-2B-1) (COMPONENT-BASE PART-2B-B-2 BASE-2B-2)
  (COMPONENT-BASE PART-2B-B-3 BASE-2B-3) (COMPONENT-BASE PART-2B-B-4 BASE-2B-4)
  ...
  (COMPONENT-BASE PART-2B-C-4 BASE-2B-4) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-4) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-4) (FREE ARM1) (AT ARM1 TRAY-A)
 ...
 (:GOAL
  (AND (AT BASE-2A-0 CARRY-OUT) (FINISHED 2A-INSPECT-BASE BASE-2A-0)
       (AT BASE-2A-1 CARRY-OUT) (FINISHED 2A-INSPECT-BASE BASE-2A-1)
       (AT BASE-2A-2 CARRY-OUT) (FINISHED 2A-INSPECT-BASE BASE-2A-2)
       (AT BASE-2A-3 CARRY-OUT) (FINISHED 2A-INSPECT-BASE BASE-2A-3)
       (AT BASE-2A-4 CARRY-OUT) (FINISHED 2A-INSPECT-BASE BASE-2A-4)
       (AT BASE-2B-0 CARRY-OUT) (FINISHED 2B-SCREW-C BASE-2B-0)
       (AT BASE-2B-1 CARRY-OUT) (FINISHED 2B-SCREW-C BASE-2B-1)
       (AT BASE-2B-2 CARRY-OUT) (FINISHED 2B-SCREW-C BASE-2B-2)
       (AT BASE-2B-3 CARRY-OUT) (FINISHED 2B-SCREW-C BASE-2B-3)
       (AT BASE-2B-4 CARRY-OUT) (FINISHED 2B-SCREW-C BASE-2B-4)))

(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-21)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  BASE-2A-19 BASE-2A-20 BASE-2B-0 BASE-2B-1 BASE-2B-2 BASE-2B-3 BASE-2B-4
  ...
  BASE-2B-19 BASE-2B-20 - BASE PART-2A-A-0 PART-2A-A-1 PART-2A-A-2 PART-2A-A-3
  ...
  PART-2A-A-16 PART-2A-A-17 PART-2A-A-18 PART-2A-A-19 PART-2A-A-20 PART-2A-B-0
  ...
  PART-2A-B-19 PART-2A-B-20 PART-2A-C-0 PART-2A-C-1 PART-2A-C-2 PART-2A-C-3
  ...
  PART-2A-C-16 PART-2A-C-17 PART-2A-C-18 PART-2A-C-19 PART-2A-C-20 PART-2B-A-0
  ...
  PART-2B-A-19 PART-2B-A-20 PART-2B-B-0 PART-2B-B-1 PART-2B-B-2 PART-2B-B-3
  ...
  PART-2B-B-16 PART-2B-B-17 PART-2B-B-18 PART-2B-B-19 PART-2B-B-20 PART-2B-C-0
  ...
  PART-2B-C-19 PART-2B-C-20 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY TABLE1
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-20 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-20 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-20 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-20 TRAY-A)
  ...
  (COMPONENT-BASE PART-2B-C-20 BASE-2B-20) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-20) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-20) (FREE ARM1) (AT ARM1 TRAY-A)

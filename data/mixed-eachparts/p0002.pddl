(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-2)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2B-0 BASE-2B-1 - BASE
  PART-2A-A-0 PART-2A-A-1 PART-2A-B-0 PART-2A-B-1 PART-2A-C-0 PART-2A-C-1
  PART-2B-A-0 PART-2B-A-1 PART-2B-B-0 PART-2B-B-1 PART-2B-C-0 PART-2B-C-1 -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-1 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-1 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-1 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-1 TRAY-A)
  ...
  (AT BASE-2B-1 CARRY-IN) (FINISHED NOTHING-DONE BASE-2B-1) (FREE ARM1)

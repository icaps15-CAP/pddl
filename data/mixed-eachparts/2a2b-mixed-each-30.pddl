(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-30)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  BASE-2A-26 BASE-2A-27 BASE-2A-28 BASE-2A-29 BASE-2B-0 BASE-2B-1 BASE-2B-2
  ...
  BASE-2B-24 BASE-2B-25 BASE-2B-26 BASE-2B-27 BASE-2B-28 BASE-2B-29 - BASE
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-29 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-ATTATCH-B TABLE2) (= (JOB-COST J2A-OIL-CYLINDER) 2)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-29 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-29 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-29 TRAY-A)
  ...
  (COMPONENT-BASE PART-2B-C-29 BASE-2B-29) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-29) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-29) (FREE ARM1) (AT ARM1 TRAY-A)

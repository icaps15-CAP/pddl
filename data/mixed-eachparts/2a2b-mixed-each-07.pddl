(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-7)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  BASE-2A-5 BASE-2A-6 BASE-2B-0 BASE-2B-1 BASE-2B-2 BASE-2B-3 BASE-2B-4
  BASE-2B-5 BASE-2B-6 - BASE PART-2A-A-0 PART-2A-A-1 PART-2A-A-2 PART-2A-A-3
  PART-2A-A-4 PART-2A-A-5 PART-2A-A-6 PART-2A-B-0 PART-2A-B-1 PART-2A-B-2
  PART-2A-B-3 PART-2A-B-4 PART-2A-B-5 PART-2A-B-6 PART-2A-C-0 PART-2A-C-1
  PART-2A-C-2 PART-2A-C-3 PART-2A-C-4 PART-2A-C-5 PART-2A-C-6 PART-2B-A-0
  ...
  PART-2B-B-6 PART-2B-C-0 PART-2B-C-1 PART-2B-C-2 PART-2B-C-3 PART-2B-C-4
  PART-2B-C-5 PART-2B-C-6 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY TABLE1 TABLE2
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-6 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-6 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-6 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-6 TRAY-A)
  ...
  (COMPONENT-BASE PART-2A-A-6 BASE-2A-6) (COMPONENT-BASE PART-2A-B-0 BASE-2A-0)
  ...
  (COMPONENT-BASE PART-2A-C-6 BASE-2A-6) (COMPONENT-BASE PART-2B-A-0 BASE-2B-0)
  ...
  (COMPONENT-BASE PART-2B-B-6 BASE-2B-6) (COMPONENT-BASE PART-2B-C-0 BASE-2B-0)
  ...
  (AT BASE-2B-6 CARRY-IN) (FINISHED NOTHING-DONE BASE-2B-6) (FREE ARM1)

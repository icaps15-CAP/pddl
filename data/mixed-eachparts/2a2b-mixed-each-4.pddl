(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-4)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2B-0
  BASE-2B-1 BASE-2B-2 BASE-2B-3 - BASE PART-2A-A-0 PART-2A-A-1 PART-2A-A-2
  PART-2A-A-3 PART-2A-B-0 PART-2A-B-1 PART-2A-B-2 PART-2A-B-3 PART-2A-C-0
  PART-2A-C-1 PART-2A-C-2 PART-2A-C-3 PART-2B-A-0 PART-2B-A-1 PART-2B-A-2
  PART-2B-A-3 PART-2B-B-0 PART-2B-B-1 PART-2B-B-2 PART-2B-B-3 PART-2B-C-0
  PART-2B-C-1 PART-2B-C-2 PART-2B-C-3 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY
  TABLE1 TABLE2 - TABLE GASKET-MACHINE SCREW-MACHINE-A OILING-MACHINE
  SCREW-MACHINE-C INSPECTION-MACHINE - MACHINE 2A-INSERT-GASKET - MACHINE-JOB
  2A-ATTATCH-A - JOB 2A-SCREW-A - MACHINE-JOB 2A-OIL-CYLINDER - MACHINE-JOB
  2A-ATTATCH-B - JOB 2A-ATTATCH-C - JOB 2A-SCREW-C - MACHINE-JOB
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (CONNECTED TABLE-OUT CARRY-OUT) (= (JOB-COST 2A-INSPECT-BASE) 3)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-3 TRAY-C)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-3 TRAY-A)
  ...
  (JOB-AVAILABLE-AT 2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-3 TRAY-C)
  ...
  (USES 2B-ATTATCH-C PART-2B-C-0) (= (JOB-COST 2B-ATTATCH-C) 3)
  ...
  (JOB-AVAILABLE-AT 2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-3 TRAY-A)
  ...
  (COMPONENT-BASE PART-2A-A-3 BASE-2A-3) (COMPONENT-BASE PART-2A-B-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-B-1 BASE-2A-1) (COMPONENT-BASE PART-2A-B-2 BASE-2A-2)
  (COMPONENT-BASE PART-2A-B-3 BASE-2A-3) (COMPONENT-BASE PART-2A-C-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-C-1 BASE-2A-1) (COMPONENT-BASE PART-2A-C-2 BASE-2A-2)
  (COMPONENT-BASE PART-2A-C-3 BASE-2A-3) (COMPONENT-BASE PART-2B-A-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-A-1 BASE-2B-1) (COMPONENT-BASE PART-2B-A-2 BASE-2B-2)
  (COMPONENT-BASE PART-2B-A-3 BASE-2B-3) (COMPONENT-BASE PART-2B-B-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-B-1 BASE-2B-1) (COMPONENT-BASE PART-2B-B-2 BASE-2B-2)
  (COMPONENT-BASE PART-2B-B-3 BASE-2B-3) (COMPONENT-BASE PART-2B-C-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-C-1 BASE-2B-1) (COMPONENT-BASE PART-2B-C-2 BASE-2B-2)
  (COMPONENT-BASE PART-2B-C-3 BASE-2B-3) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-3) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-3) (FREE ARM1) (AT ARM1 TRAY-A)

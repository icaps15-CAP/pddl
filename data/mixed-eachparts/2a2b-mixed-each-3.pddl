(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-3)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2B-0 BASE-2B-1
  BASE-2B-2 - BASE PART-2A-A-0 PART-2A-A-1 PART-2A-A-2 PART-2A-B-0 PART-2A-B-1
  PART-2A-B-2 PART-2A-C-0 PART-2A-C-1 PART-2A-C-2 PART-2B-A-0 PART-2B-A-1
  PART-2B-A-2 PART-2B-B-0 PART-2B-B-1 PART-2B-B-2 PART-2B-C-0 PART-2B-C-1
  PART-2B-C-2 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY TABLE1 TABLE2 - TABLE
  GASKET-MACHINE SCREW-MACHINE-A OILING-MACHINE SCREW-MACHINE-C
  INSPECTION-MACHINE - MACHINE 2A-INSERT-GASKET - MACHINE-JOB 2A-ATTATCH-A -
  JOB 2A-SCREW-A - MACHINE-JOB 2A-OIL-CYLINDER - MACHINE-JOB 2A-ATTATCH-B - JOB
  2A-ATTATCH-C - JOB 2A-SCREW-C - MACHINE-JOB 2A-INSPECT-BASE - MACHINE-JOB
  2B-ATTATCH-A - JOB 2B-SCREW-A - MACHINE-JOB 2B-ATTATCH-B - JOB 2B-ATTATCH-C -
  JOB 2B-SCREW-C - MACHINE-JOB)
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-2 TRAY-C)
  ...
  (JOB-AVAILABLE-AT 2A-ATTATCH-B TABLE2) (= (JOB-COST 2A-OIL-CYLINDER) 3)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-2 TRAY-A)
  ...
  (JOB-AVAILABLE-AT 2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-2 TRAY-C)
  ...
  (= (JOB-COST 2B-ATTATCH-B) 2) (DEPENDS 2B-SCREW-A 2B-ATTATCH-B)
  (JOB-AVAILABLE-AT 2B-ATTATCH-B TABLE1) (= (JOB-COST 2B-SCREW-A) 3)
  (DEPENDS 2B-ATTATCH-A 2B-SCREW-A)
  (JOB-AVAILABLE-AT 2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-2 TRAY-A)
  ...
  (COMPONENT-BASE PART-2A-B-2 BASE-2A-2) (COMPONENT-BASE PART-2A-C-0 BASE-2A-0)
  ...
  (COMPONENT-BASE PART-2B-A-2 BASE-2B-2) (COMPONENT-BASE PART-2B-B-0 BASE-2B-0)

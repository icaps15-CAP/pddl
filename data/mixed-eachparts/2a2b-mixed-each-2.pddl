(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-2)
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (= (JOB-COST 2A-SCREW-C) 2) (DEPENDS 2A-ATTATCH-C 2A-SCREW-C)
  (JOB-AVAILABLE-AT 2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-1 TRAY-C)
  ...
  (JOB-AVAILABLE-AT 2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-1 TRAY-A)
  ...
  (JOB-AVAILABLE-AT 2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-1 TRAY-C)
  ...
  (JOB-AVAILABLE-AT 2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-1 TRAY-A)
  ...
  (COMPONENT-BASE PART-2A-A-1 BASE-2A-1) (COMPONENT-BASE PART-2A-B-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-B-1 BASE-2A-1) (COMPONENT-BASE PART-2A-C-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-C-1 BASE-2A-1) (COMPONENT-BASE PART-2B-A-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-A-1 BASE-2B-1) (COMPONENT-BASE PART-2B-B-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-B-1 BASE-2B-1) (COMPONENT-BASE PART-2B-C-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-C-1 BASE-2B-1) (AT BASE-2A-0 CARRY-IN)
  (FINISHED NOTHING-DONE BASE-2A-0) (AT BASE-2A-1 CARRY-IN)
  (FINISHED NOTHING-DONE BASE-2A-1) (AT BASE-2B-0 CARRY-IN)
  (FINISHED NOTHING-DONE BASE-2B-0) (AT BASE-2B-1 CARRY-IN)
  (FINISHED NOTHING-DONE BASE-2B-1) (FREE ARM1) (AT ARM1 TRAY-A)

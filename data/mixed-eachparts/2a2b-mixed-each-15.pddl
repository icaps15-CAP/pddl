(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-15)
 ...
 (:OBJECTS ARM1 ARM2 - ARM BASE-2A-0 BASE-2A-1 BASE-2A-2 BASE-2A-3 BASE-2A-4
  ...
  BASE-2A-12 BASE-2A-13 BASE-2A-14 BASE-2B-0 BASE-2B-1 BASE-2B-2 BASE-2B-3
  BASE-2B-4 BASE-2B-5 BASE-2B-6 BASE-2B-7 BASE-2B-8 BASE-2B-9 BASE-2B-10
  BASE-2B-11 BASE-2B-12 BASE-2B-13 BASE-2B-14 - BASE PART-2A-A-0 PART-2A-A-1
  ...
  PART-2A-A-14 PART-2A-B-0 PART-2A-B-1 PART-2A-B-2 PART-2A-B-3 PART-2A-B-4
  PART-2A-B-5 PART-2A-B-6 PART-2A-B-7 PART-2A-B-8 PART-2A-B-9 PART-2A-B-10
  PART-2A-B-11 PART-2A-B-12 PART-2A-B-13 PART-2A-B-14 PART-2A-C-0 PART-2A-C-1
  ...
  PART-2A-C-14 PART-2B-A-0 PART-2B-A-1 PART-2B-A-2 PART-2B-A-3 PART-2B-A-4
  PART-2B-A-5 PART-2B-A-6 PART-2B-A-7 PART-2B-A-8 PART-2B-A-9 PART-2B-A-10
  PART-2B-A-11 PART-2B-A-12 PART-2B-A-13 PART-2B-A-14 PART-2B-B-0 PART-2B-B-1
  ...
  PART-2B-B-14 PART-2B-C-0 PART-2B-C-1 PART-2B-C-2 PART-2B-C-3 PART-2B-C-4
  PART-2B-C-5 PART-2B-C-6 PART-2B-C-7 PART-2B-C-8 PART-2B-C-9 PART-2B-C-10
  PART-2B-C-11 PART-2B-C-12 PART-2B-C-13 PART-2B-C-14 - COMPONENT TRAY-A TRAY-B
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-14 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-14 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-14 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-14 TRAY-A)
  ...
  (COMPONENT-BASE PART-2B-C-14 BASE-2B-14) (AT BASE-2A-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2A-14) (AT BASE-2B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE BASE-2B-14) (FREE ARM1) (AT ARM1 TRAY-A)

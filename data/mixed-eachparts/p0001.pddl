(DEFINE (PROBLEM CELL-ASSEMBLY-2A2B-MIXED-EACH-1)
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-C SCREW-MACHINE-C) (AT PART-2A-C-0 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2A-SCREW-A SCREW-MACHINE-A) (AT PART-2A-A-0 TRAY-A)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-C SCREW-MACHINE-C) (AT PART-2B-C-0 TRAY-C)
  ...
  (JOB-AVAILABLE-AT J2B-SCREW-A SCREW-MACHINE-A) (AT PART-2B-A-0 TRAY-A)
  ...
  (COMPONENT-BASE PART-2A-A-0 BASE-2A-0) (COMPONENT-BASE PART-2A-B-0 BASE-2A-0)
  (COMPONENT-BASE PART-2A-C-0 BASE-2A-0) (COMPONENT-BASE PART-2B-A-0 BASE-2B-0)
  (COMPONENT-BASE PART-2B-B-0 BASE-2B-0) (COMPONENT-BASE PART-2B-C-0 BASE-2B-0)
  (AT BASE-2A-0 CARRY-IN) (FINISHED NOTHING-DONE BASE-2A-0)
  (AT BASE-2B-0 CARRY-IN) (FINISHED NOTHING-DONE BASE-2B-0) (FREE ARM1)

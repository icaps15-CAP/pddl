(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-EACH-2)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM - ARM B-0 B-1 - BASE PART-A-0 PART-A-1 PART-B-0 PART-B-1
  PART-C-0 PART-C-1 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY TABLE1 - TABLE
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM SCREW-MACHINE-C)
  ...
  (COMPONENT-BASE PART-A-1 B-1) (COMPONENT-BASE PART-B-0 B-0)
  (COMPONENT-BASE PART-B-1 B-1) (COMPONENT-BASE PART-C-0 B-0)
  (COMPONENT-BASE PART-C-1 B-1) (AT B-0 CARRY-IN) (FINISHED NOTHING-DONE B-0)

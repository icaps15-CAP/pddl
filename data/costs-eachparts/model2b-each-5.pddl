(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-EACH-5)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM - ARM B-0 B-1 B-2 B-3 B-4 - BASE PART-A-0 PART-A-1 PART-A-2
  PART-A-3 PART-A-4 PART-B-0 PART-B-1 PART-B-2 PART-B-3 PART-B-4 PART-C-0
  PART-C-1 PART-C-2 PART-C-3 PART-C-4 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY
  TABLE1 - TABLE SCREW-MACHINE-A SCREW-MACHINE-C - MACHINE ATTATCH-A - JOB
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM SCREW-MACHINE-C)
  ...
  (JOB-AVAILABLE-AT SCREW-C SCREW-MACHINE-C) (AT PART-C-4 TRAY-C)
  ...
  (JOB-AVAILABLE-AT ATTATCH-C TABLE1) (AT PART-B-4 TRAY-B)
  ...
  (COMPONENT-BASE PART-B-4 B-4) (COMPONENT-BASE PART-C-0 B-0)
  (COMPONENT-BASE PART-C-1 B-1) (COMPONENT-BASE PART-C-2 B-2)
  (COMPONENT-BASE PART-C-3 B-3) (COMPONENT-BASE PART-C-4 B-4) (AT B-0 CARRY-IN)

(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-EACH-5)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 B-2 B-3 B-4 - BASE PART-A-0 PART-A-1
  PART-A-2 PART-A-3 PART-A-4 PART-B-0 PART-B-1 PART-B-2 PART-B-3 PART-B-4
  PART-C-0 PART-C-1 PART-C-2 PART-C-3 PART-C-4 - COMPONENT TRAY-A TRAY-B TRAY-C
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (COMPONENT-BASE PART-A-4 B-4) (COMPONENT-BASE PART-B-0 B-0)
  ...
  (COMPONENT-BASE PART-C-4 B-4) (AT B-0 CARRY-IN) (FINISHED NOTHING-DONE B-0)
  ...
  (AT B-4 CARRY-IN) (FINISHED NOTHING-DONE B-4) (FREE ARM1) (AT ARM1 TRAY-A)

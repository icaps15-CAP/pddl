(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-EACH-3)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 B-2 - BASE PART-A-0 PART-A-1 PART-A-2
  PART-B-0 PART-B-1 PART-B-2 PART-C-0 PART-C-1 PART-C-2 - COMPONENT TRAY-A
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT ATTATCH-C TABLE2) (AT PART-B-2 TRAY-B)
  ...
  (FINISHED NOTHING-DONE B-2) (FREE ARM1) (AT ARM1 TRAY-A) (ARM-PRESENT TRAY-A)

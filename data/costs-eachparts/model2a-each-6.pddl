(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-EACH-6)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 B-2 B-3 B-4 B-5 - BASE PART-A-0 PART-A-1
  PART-A-2 PART-A-3 PART-A-4 PART-A-5 PART-B-0 PART-B-1 PART-B-2 PART-B-3
  PART-B-4 PART-B-5 PART-C-0 PART-C-1 PART-C-2 PART-C-3 PART-C-4 PART-C-5 -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (JOB-AVAILABLE-AT ATTATCH-C TABLE2) (AT PART-B-5 TRAY-B)
  ...
  (COMPONENT-BASE PART-C-4 B-4) (COMPONENT-BASE PART-C-5 B-5) (AT B-0 CARRY-IN)
  ...
  (AT B-5 CARRY-IN) (FINISHED NOTHING-DONE B-5) (FREE ARM1) (AT ARM1 TRAY-A)

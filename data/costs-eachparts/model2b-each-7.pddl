(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-EACH-7)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM - ARM B-0 B-1 B-2 B-3 B-4 B-5 B-6 - BASE PART-A-0 PART-A-1
  ...
  TABLE SCREW-MACHINE-A SCREW-MACHINE-C - MACHINE ATTATCH-A - JOB SCREW-A -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM SCREW-MACHINE-C)
  ...
  (JOB-AVAILABLE-AT SCREW-C SCREW-MACHINE-C) (AT PART-C-6 TRAY-C)
  ...
  (JOB-AVAILABLE-AT SCREW-A SCREW-MACHINE-A) (AT PART-A-6 TRAY-A)
  ...
  (COMPONENT-BASE PART-B-6 B-6) (COMPONENT-BASE PART-C-0 B-0)
  (COMPONENT-BASE PART-C-1 B-1) (COMPONENT-BASE PART-C-2 B-2)
  (COMPONENT-BASE PART-C-3 B-3) (COMPONENT-BASE PART-C-4 B-4)
  (COMPONENT-BASE PART-C-5 B-5) (COMPONENT-BASE PART-C-6 B-6) (AT B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE B-6) (FREE ARM) (AT ARM TABLE-IN)
 ...
 (:GOAL
  (AND (AT B-0 CARRY-OUT) (FINISHED SCREW-C B-0) (AT B-1 CARRY-OUT)
       ...
       (AT B-6 CARRY-OUT) (FINISHED SCREW-C B-6)))

(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-EACH-1)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM - ARM B-0 - BASE PART-A-0 PART-B-0 PART-C-0 - COMPONENT TRAY-A
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM SCREW-MACHINE-C)
  ...
  (JOB-AVAILABLE-AT SCREW-C SCREW-MACHINE-C) (AT PART-C-0 TRAY-C)
  ...
  (JOB-AVAILABLE-AT SCREW-A SCREW-MACHINE-A) (AT PART-A-0 TRAY-A)
  ...
  (COMPONENT-BASE PART-B-0 B-0) (COMPONENT-BASE PART-C-0 B-0) (AT B-0 CARRY-IN)
  (FINISHED NOTHING-DONE B-0) (FREE ARM) (AT ARM TABLE-IN)

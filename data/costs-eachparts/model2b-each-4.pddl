(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-EACH-4)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM - ARM B-0 B-1 B-2 B-3 - BASE PART-A-0 PART-A-1 PART-A-2 PART-A-3
  PART-B-0 PART-B-1 PART-B-2 PART-B-3 PART-C-0 PART-C-1 PART-C-2 PART-C-3 -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM SCREW-MACHINE-C)
  ...
  (JOB-AVAILABLE-AT SCREW-C SCREW-MACHINE-C) (AT PART-C-3 TRAY-C)
  ...
  (JOB-AVAILABLE-AT SCREW-A SCREW-MACHINE-A) (AT PART-A-3 TRAY-A)
  ...
  (COMPONENT-BASE PART-A-3 B-3) (COMPONENT-BASE PART-B-0 B-0)
  (COMPONENT-BASE PART-B-1 B-1) (COMPONENT-BASE PART-B-2 B-2)
  (COMPONENT-BASE PART-B-3 B-3) (COMPONENT-BASE PART-C-0 B-0)
  (COMPONENT-BASE PART-C-1 B-1) (COMPONENT-BASE PART-C-2 B-2)
  (COMPONENT-BASE PART-C-3 B-3) (AT B-0 CARRY-IN) (FINISHED NOTHING-DONE B-0)
 ...
 (:GOAL
  (AND (AT B-0 CARRY-OUT) (FINISHED SCREW-C B-0) (AT B-1 CARRY-OUT)
       ...
       (AT B-3 CARRY-OUT) (FINISHED SCREW-C B-3)))

(define (problem barman-large-76-4-76-44)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot63 cocktail56)
     (contains shot64 cocktail35)

(define (problem barman-large2-102-4-102-57)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot31 cocktail102)
     (contains shot32 cocktail7)
     (contains shot33 cocktail88)
     ...
     (contains shot57 cocktail77)
     (contains shot58 cocktail87)
     (contains shot59 cocktail101)

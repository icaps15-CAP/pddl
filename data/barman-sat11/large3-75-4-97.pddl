(define (problem barman-75-4-97)
 ...
 (:goal
  (and
     ...
     (contains shot86 cocktail30)
     (contains shot87 cocktail18)
     (contains shot88 ingredient2)
     (contains shot89 ingredient3)

(define (problem barman-large2-101-4-101-56)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot4 cocktail82)
     (contains shot5 cocktail39)
     (contains shot6 cocktail66)
     (contains shot7 cocktail83)
     (contains shot8 cocktail61)
     ...
     (contains shot37 cocktail100)
     (contains shot38 cocktail88)
     (contains shot39 cocktail26)
     (contains shot40 cocktail17)
     (contains shot41 cocktail33)
     (contains shot42 cocktail56)
     ...
     (contains shot83 cocktail13)
     (contains shot84 cocktail98)
     (contains shot85 cocktail5)
     (contains shot86 cocktail86)
     (contains shot87 cocktail51)
     (contains shot88 cocktail19)

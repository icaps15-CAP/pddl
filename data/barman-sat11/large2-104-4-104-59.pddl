(define (problem barman-large2-104-4-104-59)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot34 cocktail78)
     (contains shot35 cocktail55)
     (contains shot36 cocktail71)
     ...
     (contains shot82 cocktail68)
     (contains shot83 cocktail76)
     (contains shot84 cocktail36)

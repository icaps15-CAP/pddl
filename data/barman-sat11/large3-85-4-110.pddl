(define (problem barman-85-4-110)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot48 cocktail62)
     (contains shot49 cocktail58)
     (contains shot50 cocktail85)
     (contains shot51 cocktail71)
     ...
     (contains shot80 cocktail77)
     (contains shot81 cocktail76)
     (contains shot82 cocktail26)

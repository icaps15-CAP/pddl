(define (problem barman-large-101-4-101-49)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot76 cocktail91)
     (contains shot77 cocktail65)
     (contains shot78 cocktail14)
     (contains shot79 cocktail97)

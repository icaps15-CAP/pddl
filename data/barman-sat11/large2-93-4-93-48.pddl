(define (problem barman-large2-93-4-93-48)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot49 cocktail74)
     (contains shot50 cocktail73)
     (contains shot51 cocktail44)
     (contains shot52 cocktail5)
     (contains shot53 cocktail83)
     (contains shot54 cocktail54)
     (contains shot55 cocktail81)
     (contains shot56 cocktail90)
     (contains shot57 cocktail76)
     ...
     (contains shot68 cocktail51)
     (contains shot69 cocktail31)
     (contains shot70 cocktail72)
     (contains shot71 cocktail91)
     (contains shot72 cocktail69)
     (contains shot73 cocktail33)
     ...
     (contains shot83 cocktail35)
     (contains shot84 cocktail19)
     (contains shot85 cocktail15)
     (contains shot86 cocktail87)
     (contains shot87 cocktail6)
     (contains shot88 cocktail34)
     (contains shot89 cocktail75)
     (contains shot90 cocktail13)
     (contains shot91 cocktail62)
     (contains shot92 cocktail27)
     (contains shot93 cocktail68)
)))

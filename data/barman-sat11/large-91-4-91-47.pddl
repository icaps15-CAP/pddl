(define (problem barman-large-91-4-91-47)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot72 cocktail77)
     (contains shot73 cocktail38)
     (contains shot74 cocktail7)
     (contains shot75 cocktail8)
     (contains shot76 cocktail26)
     (contains shot77 cocktail85)
     (contains shot78 cocktail28)

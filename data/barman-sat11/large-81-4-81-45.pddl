(define (problem barman-large-81-4-81-45)
 ...
 (:goal
  (and
     ...
     (contains shot65 cocktail65)
     (contains shot66 cocktail47)
     ...
     (contains shot77 cocktail14)
     (contains shot78 cocktail54)

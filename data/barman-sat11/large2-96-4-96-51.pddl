(define (problem barman-large2-96-4-96-51)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot62 cocktail71)
     (contains shot63 cocktail37)

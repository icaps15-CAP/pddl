(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3C-2) (:DOMAIN CELL-ASSEMBLY)
 (:OBJECTS A1 A2 A3 A4 A5 - ARM B-0 B-1 - BASE P1 P2 P3 P4 P5 P6 - COMPONENT T1
  T2 T3 T4 T5 T6 - TRAY TB-FOR-234 TB-FOR-1 TB-FOR-56 TB12 TB23 TB24 TB35 TB45
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (IS-REACHABLE A1 TABLE-IN)
  ...
  (AT A4 TB24) (ARM-PRESENT TB24) (FREE A5) (AT A5 TB45) (ARM-PRESENT TB45))
 (:GOAL

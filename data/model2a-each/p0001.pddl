(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-EACH-1)
 ...
 (:OBJECTS ARM1 ARM2 - ARM B-0 - BASE PART-A-0 PART-B-0 PART-C-0 - COMPONENT
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1)
  ...
  (COMPONENT-BASE PART-A-0 B-0) (COMPONENT-BASE PART-B-0 B-0)
  (COMPONENT-BASE PART-C-0 B-0) (AT B-0 CARRY-IN) (FINISHED NOTHING-DONE B-0)

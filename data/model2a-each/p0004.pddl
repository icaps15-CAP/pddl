(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-EACH-4)
 (:DOMAIN CELL-ASSEMBLY-EACHPARTS)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 B-2 B-3 - BASE PART-A-0 PART-A-1 PART-A-2
  PART-A-3 PART-B-0 PART-B-1 PART-B-2 PART-B-3 PART-C-0 PART-C-1 PART-C-2
  PART-C-3 - COMPONENT TRAY-A TRAY-B TRAY-C - TRAY TABLE1 TABLE2 - TABLE
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1)
  ...
  (COMPONENT-BASE PART-C-2 B-2) (COMPONENT-BASE PART-C-3 B-3) (AT B-0 CARRY-IN)
  ...
  (FINISHED NOTHING-DONE B-3) (FREE ARM1) (AT ARM1 TRAY-A) (ARM-PRESENT TRAY-A)
